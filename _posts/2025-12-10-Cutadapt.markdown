...
```
- **Assume that the number of cores (CPUs) is 24.**
- **See:** [Cutadapt cheetsheet]({{ site.baseurl }}{% post_url 2025-12-10-Cutadapt_cheetsheet %}) for how to format your commands.
